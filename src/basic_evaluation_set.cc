...
void
BasicEvaluationSet::resize (unsigned new_size, ParameterInitializer initializer)
{
...
bool
BasicEvaluationSet::next_pair (ParameterValues *& parameters, EvaluationResult *& result) throw()
{
